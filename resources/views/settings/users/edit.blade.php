...
<div class="p-6">
    <div class="max-w-2xl bg-white rounded-lg shadow-sm border border-blue-100 p-6">
        ...
        <form id="edit-user-form" action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-semibold text-blue-950 mb-1">No. HP</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-blue-950 mb-1">Telegram Chat ID (Opsional)</label>
            ...
            <div id="customer-limit-container" class="mb-4 hidden transition-all duration-300">
                <label class="block text-sm font-semibold text-blue-950 mb-1">Limit Jumlah Pelanggan</label>
            ...
            <div id="face-scan-container" class="border-2 p-4 rounded-lg bg-gray-50 mb-4 transition-all duration-300">
                <label class="block text-sm font-semibold text-blue-950 mb-2">
                    Pembaruan Wajah (Webcam Scan) 
                    @if(!$user->face_photo)
                        <span class="text-red-500">* Wajib</span>
                    @else
                        <span class="text-gray-400 font-normal">(Opsional, sudah terdaftar)</span>
                    @endif
                </label>
                ...
                <div class="flex flex-col items-center gap-3">
                    @if($user->face_photo)
                        <div class="mb-2 text-center">
                            <p class="text-xs text-gray-500 mb-1">Wajah Terdaftar Saat Ini:</p>
                            <img src="{{ asset('storage/' . $user->face_photo) }}" class="w-32 h-32 object-cover rounded-full border shadow-sm mx-auto">
                        </div>
                    @endif
            ...
            <div class="relative w-64 h-64 bg-black rounded-lg overflow-hidden border-2 border-dashed border-gray-300 flex items-center justify-center mx-auto">
